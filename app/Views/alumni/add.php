            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-body" col-md-5>
                    <form action="<?= site_url('alumni')?>" method="post" autocomplete="off">
                    <?= csrf_field()?>
                        <div class="form-group">
                          <label>Nama siswa</label>
                            <select class="form-control select2 "   name="NIS" required>
                              <?php foreach ($siswa as $key => $value)  : ?>
                                <option value="<?= $value->NIS?>"><?= $value->nm_siswa?></option>
                              <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
